...
def main(init, n, time_step):
    N_simulation(init=init, n=n, time_step=time_step, discrete_vessels=True, plantgl=False, plotting_2D=False, plotting_STM=True, logging=True)
...
main(init='example/inputs/root00020.pckl', n=240, time_step=3600)
